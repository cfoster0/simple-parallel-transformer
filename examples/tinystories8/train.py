...
def train(cfg: Config) -> None:
    ...
    # prepare first 100MB of TinyStories training set data

    with gzip.open(get_original_cwd() + '/./data/tinystories-train8.gz') as file:
    ...
    if not DRY_RUN:
        wandb.init(project="transformer-tinystories-interp", config=config)
